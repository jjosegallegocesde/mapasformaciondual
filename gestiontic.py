...
# Leer el archivo CSV
data = pd.read_csv('./data/scopusgestion.csv')
...
plt.xlabel('Año')
plt.ylabel('Año')
plt.title('Mapa de Calor de la cantidad de artículos por año temática: gestión del conocimiento y enseñanza de TIC')
plt.tight_layout()
